...
/* package neural-net-0.1.0.0 */
#define VERSION_neural_net "0.1.0.0"
#define MIN_VERSION_neural_net(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "neural-net-0.1.0.0-SYgV3Sx5uw5ZT4aENrU9C"

#define CURRENT_PACKAGE_KEY "neural-net-0.1.0.0-SYgV3Sx5uw5ZT4aENrU9C"
